...
type
  TcoServer372 = class(TRemoteDataModule, IcoServer372)
...
class procedure TcoServer372.UpdateRegistry(Register: Boolean; const ClassID, ProgID: string);
begin
  if Register then
  begin
...
function TcoServer372.smNewFirm(const inName,
...
procedure TcoServer372.smDeleteFirm(inID: Integer);
begin
...
procedure TcoServer372.smEditFirm(inID: Integer; const inName,
...
procedure TcoServer372.RemoteDataModuleCreate(Sender: TObject);
begin
  IBDatabase1.Open;
  spNewFirm.Prepare;
  spEditFirm.Prepare;
...
procedure TcoServer372.RemoteDataModuleDestroy(Sender: TObject);
begin
  IBDatabase1.Close;
end;

function TcoServer372.smNewProduct(const inName: WideString;
...
procedure TcoServer372.smDeleteProduct(inID: Integer);
begin
...
procedure TcoServer372.smEditProduct(inID: Integer;
...
function TcoServer372.smNewNakl(inDate: TDateTime; const inNo: WideString;
...
procedure TcoServer372.smDeleteNakl(inID: Integer);
begin
...
procedure TcoServer372.smNewInfo(inNID, inPID, inCID: Integer; inKolvo,
  inTotal: Single);
begin
...
procedure TcoServer372.smDeleteInfo(inNID, inPID, inCID: Integer);
begin
...
procedure TcoServer372.smQueryClear;
begin
    IBQuery1.SQL.Clear;
end;

procedure TcoServer372.smQueryAdd(const Param1: WideString);
begin
   IBQuery1.SQL.Add(Param1);
end;

initialization
  TComponentFactory.Create(ComServer, TcoServer372,
    Class_coServer372, ciMultiInstance, tmSingle);
end.
